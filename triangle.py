...
for i in range (1, 10):
    ...
    for j in range (0, i):
        line += " " + str(i * 100 + (2 * j * (i - 1))) # Add then assign (+=) the string concatenation of rows by 100 with the adjusted even multiples of j.
    print (line)                                       # The difference in column values increases by even numbers that grow as the column number increases.
